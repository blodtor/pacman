...
class Utils {
  ...
  public:
    ...
    static int       mystrncpy( char *target, const char *source, uint16_t bufLen );
...
extern const char Parm_HostsFilename[];
extern const char Parm_DHCPLeaseRequest[];
